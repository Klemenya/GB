...
#ifndef GOOGLE_PROTOBUF_INCLUDED_Univer_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_Univer_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_Univer_2eproto
...
struct TableStruct_Univer_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_Univer_2eproto;
namespace Univer {
class FullName;
...
class FullName final :
 ...
 private:
  ...
  friend struct ::TableStruct_Univer_2eproto;
};
// -------------------------------------------------------------------
...
class Student final :
 ...
 public:
  ...
  PROTOBUF_FUTURE_MUST_USE_RESULT ::Univer::FullName* release_name();
  ...
  // int32 sc_average = 3;
  void clear_sc_average();
  ::PROTOBUF_NAMESPACE_ID::int32 sc_average() const;
  void set_sc_average(::PROTOBUF_NAMESPACE_ID::int32 value);
  private:
  ::PROTOBUF_NAMESPACE_ID::int32 _internal_sc_average() const;
  void _internal_set_sc_average(::PROTOBUF_NAMESPACE_ID::int32 value);
  public:
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::int32 sc_average_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_Univer_2eproto;
};
// -------------------------------------------------------------------
...
// int32 sc_average = 3;
inline void Student::clear_sc_average() {
  sc_average_ = 0;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 Student::_internal_sc_average() const {
  return sc_average_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 Student::sc_average() const {
  // @@protoc_insertion_point(field_get:Univer.Student.sc_average)
  return _internal_sc_average();
}
inline void Student::_internal_set_sc_average(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  sc_average_ = value;
}
inline void Student::set_sc_average(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_sc_average(value);
  // @@protoc_insertion_point(field_set:Univer.Student.sc_average)
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_Univer_2eproto
